...
CAPABILITY_SECTIONS = {
    "rendering": CapabilitySection(
        ...
        (
            ...
            "Interactive DNA, neuron, cell, and data-structure laboratories",
            "Numeric bar, pie, line, scatter, and histogram charts from values supplied in the prompt",
            "Labeled 2D and 3D component schematics for supported machines, electronics, vehicles, and structures",
            "Structured flow, timeline, networking, operating-system, database, AI, security, biology, and engineering diagrams",
